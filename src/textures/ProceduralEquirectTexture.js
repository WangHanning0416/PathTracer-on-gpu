//用于生成等距圆柱纹理
import {ClampToEdgeWrapping,Color,DataTexture,EquirectangularReflectionMapping,LinearFilter,
	RepeatWrapping,RGBAFormat,Spherical,Vector2,FloatType} from 'three';
